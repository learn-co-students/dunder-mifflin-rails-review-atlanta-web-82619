...
names = ["Cookie", "Fluffy", "Princeton", "Hanaa","Nick"]
breeds = ["Chihuaha", "Golden Retriever", "German", "Daschund", "Coach"]
ages = ["puppy", "adult", "old"]

5.times do
  Dog.create(name: names.sample, breed: breeds.sample, age: ages.sample)
end
